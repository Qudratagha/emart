...
{
$sql=mysqli_query($con,"SELECT password FROM  sprovider where password='".md5($_POST['password'])."' && name='".$_SESSION['alogin']."'");
...
if($num>0)
{
 $con=mysqli_query($con,"update sprovider set password='".md5($_POST['newpassword'])."' where name='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>SProvider | Change Password</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Service Provider | Change Password</h3>
							</div>
