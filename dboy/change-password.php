...
{
$sql=mysqli_query($con,"SELECT password FROM  dboy where password='".($_POST['password'])."' && email='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);

if($num>0)
{
 $con=mysqli_query($con,"update dboy set password='".($_POST['newpassword'])."' where email='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>DBoy| Change Password</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">new again Password</label>
<div class="controls">
