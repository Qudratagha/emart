	...
	<div class='container'>
		<div class='row outer-bottom-sm'>
			<div class='col-md-3 sidebar'>
              ...
              <?php $sql=mysqli_query($con,"select id,subcategory  from subcategory where categoryid='$catid'");
             
while($row=mysqli_fetch_array($sql))
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>&cid=<?php echo $catid; ?>" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i>
