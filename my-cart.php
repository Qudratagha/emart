				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Contine Shopping</a>
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rs"." ".$row['shippingCharge']; ?>.00</span></td>
					...
					<td><strong><?php  echo $_SESSION['cart'][$row_p["id"]]["date"]; //date("l jS \of F Y h:i:s A");
 //();
					 ?> </strong>
					</td>
				</tr>
