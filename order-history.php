...
?>
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" >
						    <img src="admin/productimages/<?php echo $row['proid'];?>/<?php echo $row['pimg1'];?>" alt="" width="100" height="120">
						</a>
					</td>
 ...
 <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/shopping/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Track</td>
						...
						<td><a href="#" onClick="return confirm('Are you sure you want to delete?')">Cancle Order</a></td>
