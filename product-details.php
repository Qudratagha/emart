							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                ...
						                <li><a class="fa fa-facebook"	style="font-size: 20px; color: #3B5998" href="#"></a></li>
						                <li><a class="fa fa-twitter" 	style="font-size: 20px; color: #00ACEE" href="#"></a></li>
						                <li><a class="fa fa-linkedin"	style="font-size: 20px; color: #0E76A8" href="#"></a></li>
						                <li><a class="fa fa-rss" 		style="font-size: 20px; color: #EE802F" href="#"></a></li>
						                <li><a class="fa fa-pinterest"	style="font-size: 20px; color: #C8232C" href="#"></a></li>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="200" alt=""></a>
			</div><!-- /.image -->			
